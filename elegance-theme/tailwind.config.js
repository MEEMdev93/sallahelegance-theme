    ...
    theme   : {
        ...
        extend    : {
            ...
            colors             : {
                ...
                'darker'       : '#0E0F0F',
                'danger'       : '#AE0A0A',
                // إضافة ألوان الموف وتدرجاته
                'primary'      : '#8E44AD', // لون الموف الأساسي
                'primary-light': '#A569BD', // لون الموف الفاتح
                'primary-dark' : '#703688', // لون الموف الداكن
                'primary-pale' : '#D6BFDD', // لون الموف الباهت
                'gold'         : '#F1C40F', // لون ذهبي للتباين
                'soft-gray'    : '#F5F5F5', // رمادي فاتح
                'elegant-gray' : '#E0E0E0', // رمادي أنيق
            },
            spacing: {
              '3.75': '15px',
              '7.5' : '30px',
            ...
            boxShadow          : {
                ...
                // إضافة ظلال جديدة للعناصر
                'elegant': '0 10px 25px rgba(142, 68, 173, 0.1)',
                'hover': '0 15px 35px rgba(142, 68, 173, 0.15)',
